...
class Hu102InitialModelSmokeTestCase(unittest.TestCase):
    ...
    def test_coupled_model_stops_when_displacement_reaches_shoe(self) -> None:
        well_spec, fluids, schedule, _ = load_hu102_tailpipe()
        ...
        self.assertAlmostEqual(stop_time_s, displacement_front_time_s, places=6)
        ...
        self.assertAlmostEqual(final_efficiency, peak_efficiency, places=6)
