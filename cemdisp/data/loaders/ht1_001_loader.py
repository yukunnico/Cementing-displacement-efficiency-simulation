...
MISSING = "MISSING"
# 读数（HT1-001 尾管化验报告 表7，128℃↓93℃（θ600 原文 `>300`，**CSV 却记 300 = 数据陷阱**，按超量程剔除）：｜300/200/100/6/3（ht1_003 含 600）：
HT1_001_LEAD_YIELD_STRESS_REPORT_GIVEN_PA = MISSING  # 路线A：报告未给定（只给 n/K）
HT1_001_LEAD_YIELD_STRESS_FITTED_PA = 0.0000  # 路线B 新推导：领浆 HB τy（读数 268/194/113/10/7，θ600 超量程）
HT1_001_INTERMEDIATE_YIELD_STRESS_REPORT_GIVEN_PA = MISSING  # 路线A：报告未给定（只给 n/K）
HT1_001_INTERMEDIATE_YIELD_STRESS_FITTED_PA = 0.0000  # 路线B 新推导：中间浆 HB τy（读数 221/165/92/7/4，θ600 超量程）
HT1_001_TAIL_YIELD_STRESS_REPORT_GIVEN_PA = MISSING  # 路线A：报告未给定（只给 n/K）
HT1_001_TAIL_YIELD_STRESS_FITTED_PA = 0.0000  # 路线B 新推导：尾浆 HB τy（读数 218/163/88/6/4，θ600 超量程）
