...
def load_hu2_tailpipe(
    *,
    ...
    fluids = (
        ...
        FluidSpec("压塞液", FluidRole.OTHER, 1900.0, RheologyModel.BINGHAM, HU2_DISPLACEMENT_PV_PA_S, HU2_DISPLACEMENT_YP_PA),
        FluidSpec("中置液", FluidRole.DISPLACEMENT, 1900.0, RheologyModel.BINGHAM, HU2_DISPLACEMENT_PV_PA_S, HU2_DISPLACEMENT_YP_PA),
