...
def _build_pipe_id_profile() -> tuple[tuple[float, float], ...]:
    ...
    段3: 5243.207~7378.051m  → 138.9mm (168.3mm尾管)
...
# ===========================================================================
# 流体密度 [实测] 来源：设计文档 + MATLAB脚本
# ===========================================================================
HT1_004_MUD_DENSITY_KG_M3 = 1900.0            # 钻井液 1.90
HT1_004_LEAD_MUD_DENSITY_KG_M3 = 1750.0       # 先导浆 1.75
HT1_004_SPACER1_DENSITY_KG_M3 = 1950.0        # 隔离液1 1.95
HT1_004_SPACER2_DENSITY_KG_M3 = 1750.0        # 隔离液2 1.75
HT1_004_LEAD_DENSITY_KG_M3 = 1930.0           # 领浆 1.93
HT1_004_TAIL_DENSITY_KG_M3 = 1900.0           # 尾浆 1.90
HT1_004_PLUG_DENSITY_KG_M3 = 1700.0           # 压塞液 1.70
HT1_004_DISPLACEMENT_DENSITY_KG_M3 = 1900.0   # 替钻井液 1.90
HT1_004_BUFFER_DENSITY_KG_M3 = 1900.0         # 保护液 1.90
HT1_004_BASE_FLUID_DENSITY_KG_M3 = 1020.0     # 基液 1.02
HT1_004_WELL_MUD_DENSITY_KG_M3 = 1900.0       # 井浆 1.90

# ===========================================================================
# 流体流变参数 [参照MATLAB脚本]
# PV=mPa·s/1000→Pa·s, YP=Pa
# ===========================================================================
HT1_004_MUD_PV_PA_S = 0.051             # 钻井液 PV=51mPa·s
HT1_004_MUD_YP_PA = 10.0                # YP=10Pa

HT1_004_LEAD_MUD_PV_PA_S = 0.060        # 先导浆 PV=60mPa·s
HT1_004_LEAD_MUD_YP_PA = 11.0           # YP=11Pa

HT1_004_SPACER_PV_PA_S = 0.065          # 隔离液 PV=65mPa·s
HT1_004_SPACER_YP_PA = 11.0             # YP=11Pa

HT1_004_LEAD_PV_PA_S = 0.200            # 领浆 PV=200mPa·s
HT1_004_LEAD_YP_PA = 14.0               # YP=14Pa

HT1_004_TAIL_PV_PA_S = 0.180            # 尾浆 PV=180mPa·s
HT1_004_TAIL_YP_PA = 14.0               # YP=14Pa

HT1_004_PLUG_PV_PA_S = 0.040            # 压塞液 PV=40mPa·s
HT1_004_PLUG_YP_PA = 9.0                # YP=9Pa

HT1_004_DISPLACEMENT_PV_PA_S = 0.040    # 替钻井液 PV=40mPa·s
HT1_004_DISPLACEMENT_YP_PA = 9.5        # YP=9.5Pa

HT1_004_BUFFER_PV_PA_S = 0.040          # 保护液 PV=40mPa·s
HT1_004_BUFFER_YP_PA = 9.2              # YP=9.2Pa

HT1_004_BASE_FLUID_PV_PA_S = 0.040      # 基液 PV=40mPa·s
HT1_004_BASE_FLUID_YP_PA = 9.0          # YP=9Pa

HT1_004_WELL_MUD_PV_PA_S = 0.040        # 井浆 PV=40mPa·s
HT1_004_WELL_MUD_YP_PA = 9.3            # YP=9.3Pa

# ===========================================================================
# 泵注体积/排量 [参照MATLAB脚本 + 设计文档]
# 尾浆后排量1.4取设计高值；替浆分段按MATLAB 12+13+13+13.1=51.1m³
# 末段+2.3m³保证尾浆全入环空(管内容积99.4，尾浆尾缘需226.4>224.1)
# ===========================================================================
HT1_004_LEAD_MUD_VOLUME_M3 = 25.0
HT1_004_SPACER1_VOLUME_M3 = 16.0
HT1_004_SPACER2_VOLUME_M3 = 10.0
HT1_004_LEAD_VOLUME_M3 = 48.0
HT1_004_TAIL_VOLUME_M3 = 28.0
HT1_004_PLUG_VOLUME_M3 = 2.0
HT1_004_DISPLACEMENT_FAST_VOLUME_M3 = 29.0
HT1_004_BUFFER_VOLUME_M3 = 14.0
HT1_004_BASE_FLUID_VOLUME_M3 = 1.0
HT1_004_WELL_MUD_1_VOLUME_M3 = 12.0     # MATLAB @1.2m³/min
HT1_004_WELL_MUD_2_VOLUME_M3 = 13.0     # MATLAB @1.0m³/min
HT1_004_WELL_MUD_3_VOLUME_M3 = 13.0     # MATLAB @0.8m³/min
HT1_004_WELL_MUD_4_VOLUME_M3 = 15.4     # MATLAB 13.1+2.3补足 @0.7m³/min

HT1_004_LEAD_MUD_RATE_M3_MIN = 1.4
HT1_004_SPACER_RATE_M3_MIN = 1.2
HT1_004_CEMENT_RATE_M3_MIN = 1.2
HT1_004_TAIL_RATE_M3_MIN = 1.4          # MATLAB取高排量端
HT1_004_PLUG_RATE_M3_MIN = 1.2
HT1_004_DISPLACEMENT_FAST_RATE_M3_MIN = 1.5
HT1_004_BUFFER_RATE_M3_MIN = 1.4
HT1_004_BASE_FLUID_RATE_M3_MIN = 1.2    # MATLAB @1.2
HT1_004_WELL_MUD_1_RATE_M3_MIN = 1.2
HT1_004_WELL_MUD_2_RATE_M3_MIN = 1.0
HT1_004_WELL_MUD_3_RATE_M3_MIN = 0.8
HT1_004_WELL_MUD_4_RATE_M3_MIN = 0.7
    ...
    *,
    ...
    well_spec = WellSpec(
        ...
        notes=(
            ...
            "流体流变参数参照MATLAB压力计算脚本。",
            "泵注程序参照MATLAB脚本+设计文档；末段替浆+2.3m³补足。",
    ...
    validation_data = ValidationData(
        ...
        notes=(
            ...
            "流体流变参数参照MATLAB压力计算脚本。",
            "泵注程序参照MATLAB脚本12+13+13+13.1方案；末段补足2.3m³。",
