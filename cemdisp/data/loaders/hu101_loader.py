...
# ⚠️⚠️ 2026-09-11 用户指令临时改动：全井常数 0.80。
# LEGACY(2026-09-11 前): (5400,0.45),(6100,0.38),(6796,0.44),(7200,0.48),(7600,0.42),(7868,0.46)，
#   均值 0.429，model_assumption（现场仅扶正器布置 132 只，无实测居中度）。
# 性质：反推情景——与现场记录"悬挂器坐挂失败、座底固井，居中度下降"
#   （2011114.doc 七、固井质量分析 / cbl_evaluation.csv）方向相反，
#   **不得作为模型验证数字引用**。基线结果备份在
#   results/_呼101_基线备份_居中度0.43_2026-09-11/，可用 git 回退本行。
_ASSUMED_STANDOFF = (
    (HU101_TOP_MD_M, 0.80), (HU101_BOTTOM_MD_M, 0.80),
)
