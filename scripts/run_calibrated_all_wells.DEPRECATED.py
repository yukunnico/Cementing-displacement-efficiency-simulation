# DEPRECATED: 依赖 scripts/p3_p4_integration.DEPRECATED.py 的已删 metrics 列 cbl_eval_interval_efficiency
# （validation/ 于 2026-07-29 删除，运行即 KeyError），且标定参数 M=500/alpha=0.05 来自
# 已废弃的旧参数扫描。参见 scripts/entrypoints/cbl_window_comparison.py（B1 新建）
